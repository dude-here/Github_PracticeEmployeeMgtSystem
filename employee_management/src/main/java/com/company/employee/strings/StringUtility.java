...
public class StringUtility {
	...
	// 5. Check Palindrome String and ADDED FEature via Local StringOperationFeature
	// branch
	public boolean isPalindrome(String text) {
		return text.equalsIgnoreCase(new StringBuilder(text).reverse().toString());
	}

	// 6. Check Numeric method added via same Local StringOperationFeature after 
	//first successfull PR
